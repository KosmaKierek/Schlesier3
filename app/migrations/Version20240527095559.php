 ...
 */
final class Version20240527095559 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tasks_tags (category_id INT NOT NULL, tag_id INT NOT NULL, INDEX IDX_85533A5012469DE2 (category_id), INDEX IDX_85533A50BAD26311 (tag_id), PRIMARY KEY(category_id, tag_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE tasks_tags ADD CONSTRAINT FK_85533A5012469DE2 FOREIGN KEY (category_id) REFERENCES categories (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tasks_tags DROP FOREIGN KEY FK_85533A5012469DE2');
